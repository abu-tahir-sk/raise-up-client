...
const Footer = () => {
  ...
  <aside>
   <div className="flex justify-center items-center gap-4">
     ...
     <h2 className="text-3xl font-extrabold text-[#1abde1]">RISE <span className=" font-bold text-gray-700">Up</span></h2>
   </div>
    <nav className="font-bold flex justify-center items-center gap-4 list-none">
    <li>
